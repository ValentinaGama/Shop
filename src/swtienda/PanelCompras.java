 ...
 * @author valentina
 */
public class PanelCompras extends javax.swing.JPanel implements ActionListener, MouseListener, ItemListener
{
    ...
    private void initComponents() {
        ...
        jButton7.setText("Guardar Compra");
    ...
    public void llenarcombos()
      {
        listaProveedores = this.gestorProv.getTodos();
        this.jComboBox1.removeAllItems();
        this.jComboBox1.addItem("seleccione un proveedor");
    ...
    private void salvarProducto()
    {
        ...
        Operaciones elProdu=new Operaciones(factura,fechaF,proveedor,total,this.tipo,1);
    ...
    private void verTodas() 
    {
       ...
       Compras xxx= new Compras(this.ppal);
    }
