 ...
 * @author valentina
 */
public class Ventas extends javax.swing.JFrame implements ActionListener, ItemListener, MouseListener
{
    ...
    public Ventas(Ppal ppal)
    {
        ...
        this.modelaTabla();
        this.LlenaCombo();
        this.traeOperacioness();
    }
    
    private void traeOperacioness()
    {
    ...
    private void LlenaCombo()
    {
        ...
        this.jComboBox1.addItem("Cliente");
    ...
    { 
        ...
        PanelFactura xxx= new PanelFactura(this, dato, tot);
    }
